...
class Main extends Base {
    ...
    public function getTaskarticle(){
        ...
        $config = config('app')['task']['article'];
    ...
    public function getStartup(){
        ...
        $player['app_logo'] = $macConfig['app']['app_logo'];
        ...
        $data = [
            ...
            'app_user_adurl' => $macConfig['user']['app_user_adurl'],
            'app_ui_tab_fun' => $macConfig['user']['app_sdk_xtw_dsp'],
            'app_cc_fd_jc' => $macConfig['sms']['tpl_code_findpass'],
            'app_banner_style' => $macConfig['user']['app_banner_style'],
            'app_home_ads' => $macConfig['user']['app_home_ads'],
            'app_theme_ui' => $macConfig['user']['app_theme_ui'],
            'app_login_type' => $macConfig['user']['app_login_type'],
            'ui_home_topbg' => $macConfig['user']['app_ui_home_topbg'],
            'vip_purchase' => $macConfig['user']['vip_purchase'],
            'online_recharge' => $macConfig['user']['online_recharge'],
            'search_hot' => explode(',',$macConfig['app']['search_hot']),
            'ui_home_data' => $macConfig['user']['app_third_ui_home_data'],
            'app_play_recommend' => $macConfig['user']['app_play_recommend'],
            'app_ui_home_small_icons' => $macConfig['user']['app_ui_home_small_icons'],
            
        ];
        // print_r("<pre>");print_r($macConfig);exit();
    ...
    private function ec_path_to_imageurl($path){
        $preg = "/^http(s)?:\\/\\/.+/";
