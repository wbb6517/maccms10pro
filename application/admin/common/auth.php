...
return array (
  ...
  /*
   * ============================================================
   * 模版模块 (Template Module)
   * ============================================================
   *
   * 【模块说明】
   * 管理网站前台模板文件、广告代码和模板标签
   * 提供在线编辑模板文件的功能
   *
   * 【子菜单】
   * - 模板管理  : 浏览和编辑模板目录下的文件
   * - 广告位管理: 管理广告 JS 文件，生成调用代码
   * - 标签向导  : 可视化生成模板标签代码
   *
   * 【模板目录结构】
   * ./template/{模板名}/
  ...
  array (
    ...
    array (
      // ----- 模板管理 -----
      // 浏览和编辑 ./template 目录下的模板文件
      // 支持 html/htm/js/xml 格式文件的在线编辑
      71 =>
      array (
        'show' => 1,
      ...
      // ----- 广告位管理 -----
      // 管理当前模板下的广告 JS 文件
      // 广告文件路径: ./template/{模板名}/{广告目录}/
      // 默认广告目录: ads (可在系统配置中修改)
      // 提供一键复制调用代码功能: <script src="{$maccms.path_ads}xxx.js"></script>
      72 =>
      array (
        'show' => 1,
        'name' => lang('menu/ads'),
      ...
      // ----- 标签向导 -----
      // 可视化模板标签生成工具
      // 支持生成: vod/art/type/topic/link/gbook/comment 等标签
      // 帮助用户快速生成 {maccms:xxx} 格式的模板代码
      73 =>
      array (
        'show' => 1,
